...
import { getCampaignVisitorsData } from "@/server-utils/mock/charts.services";
  ...
  return (
    ...
    >
      <div className="border-b border-stroke px-6 py-5.5 dark:border-dark-3">
        ...
        <div className="flex justify-between">
          <div className="text-sm font-medium">Quanto tempo è necessario per i nostri power-up (settimane medie)</div>
