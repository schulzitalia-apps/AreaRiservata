...
type Props = {
  ...
  setTimeKey: (v: BilancioTimeKey) => void;
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      <div>
        <div className="flex flex-wrap items-center gap-2">
          <h1 className="text-xl font-extrabold text-dark dark:text-white">Bilancio</h1>
      ...
      <div className="w-[220px]">
        <Select
          value={props.timeKey}
          onChange={(v) => props.setTimeKey(v as BilancioTimeKey)}
