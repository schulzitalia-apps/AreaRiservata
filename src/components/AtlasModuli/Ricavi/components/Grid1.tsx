      ...
      <div className="lg:col-span-3">
        <Card className="h-full">
          ...
          <div className="px-4 pb-5 pt-3">
            <div className="mb-2 text-sm font-extrabold text-dark dark:text-white">Avanzamento ricavi</div>
            ...
            <RadialGauge<"periodo">
              ...
              defaultKey="periodo"
              size="large"
              colorFrom={props.deltaIsUp ? "#22C55E" : "#FB923C"}
              colorTo={props.deltaIsUp ? "#0ABEF9" : "#EF4444"}
              className="-mx-2"
            />
      ...
      <div className="lg:col-span-6">
        <Card className="h-full">
          <div className="px-5 pt-5">
            <div className="text-xs font-semibold text-gray-500 dark:text-dark-6">Distribuzione ricavi</div>
          ...
          <div className="px-4 pb-4">
            <div className="mb-3">
              ...
              <input
                ...
                placeholder="Es. fattura, commessa, bando..."
                className={cn(
