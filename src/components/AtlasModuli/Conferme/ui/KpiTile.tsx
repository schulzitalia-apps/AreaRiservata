      ...
      <div className="relative flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            <div className="text-xs font-extrabold uppercase tracking-wide text-gray-600 dark:text-dark-6">{title}</div>
          </div>

          <div className="mt-2 truncate text-xl font-black text-dark dark:text-white">{value}</div>
          {sub ? <div className="mt-1 truncate text-xs font-semibold text-gray-500 dark:text-dark-6">{sub}</div> : null}
        </div>
