    ...
    <Table>
      <TableHeader>
        <TableRow className="border-none uppercase">
          <TableHead className="!text-left text-gray-600 dark:text-dark-6">Consegna</TableHead>
          <TableHead className="!text-right text-gray-600 dark:text-dark-6">Valore</TableHead>
        </TableRow>
      </TableHeader>
