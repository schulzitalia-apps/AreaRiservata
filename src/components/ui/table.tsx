...
export function TableRow({
  ...
  return (
    <tr
      className={cn(
        "border-b transition-colors hover:bg-neutral-100/50 mock-[state=selected]:bg-neutral-100 dark:border-dark-3 dark:hover:bg-dark-2 dark:mock-[state=selected]:bg-neutral-800",
        className,
      )}
      {...props}
    />
