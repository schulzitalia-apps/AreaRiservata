...
export function Folder(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M9.172 4.25H5.5c-1.657 0-3 1.343-3 3v9.25c0 1.657 1.343 3 3 3h13c1.657 0 3-1.343 3-3V8.5c0-1.657-1.343-3-3-3h-6.086l-1.12-1.12A2.75 2.75 0 0 0 9.172 4.25Z" />
    </svg>
  );
}
...
export function FileText(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M14 2.75H8A3.25 3.25 0 0 0 4.75 6v12A3.25 3.25 0 0 0 8 21.25h8A3.25 3.25 0 0 0 19.25 18V8.75L14 2.75Z" />
      <path d="M14 2.75V7a1.75 1.75 0 0 0 1.75 1.75H19.25M8.75 12h6.5M8.75 15h6.5M8.75 9.5h2.5" stroke="currentColor" strokeWidth="1.5" fill="none" />
    </svg>
  );
}
...
export function Image(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      ...
      <path d="M4.5 18.5 10.2 12.8a1.5 1.5 0 0 1 2.1 0l4.2 4.2M14.8 15.2l1.4-1.4a1.5 1.5 0 0 1 2.1 0l1.2 1.2" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" />
    </svg>
  );
}

export function FileWord(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M14 2.75H8A3.25 3.25 0 0 0 4.75 6v12A3.25 3.25 0 0 0 8 21.25h8A3.25 3.25 0 0 0 19.25 18V8.75L14 2.75Z" />
      <path d="M8 10l1.2 5h.9L11.5 12l1.4 3h.9L15 10h-1l-.9 3-1.2-3h-.8l-1.2 3-.9-3H8Z" fill="currentColor" />
      <path d="M14 2.75V7a1.75 1.75 0 0 0 1.75 1.75H19.25" fill="none" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}

export function FileExcel(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M14 2.75H8A3.25 3.25 0 0 0 4.75 6v12A3.25 3.25 0 0 0 8 21.25h8A3.25 3.25 0 0 0 19.25 18V8.75L14 2.75Z" />
      <path d="m8.2 10 2.1 3-2.1 3h1.4l1.4-2 1.4 2h1.4l-2.1-3 2.1-3h-1.4l-1.4 2-1.4-2H8.2Z" fill="currentColor" />
      <path d="M14 2.75V7a1.75 1.75 0 0 0 1.75 1.75H19.25" fill="none" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}

export function FilePdf(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M14 2.75H8A3.25 3.25 0 0 0 4.75 6v12A3.25 3.25 0 0 0 8 21.25h8A3.25 3.25 0 0 0 19.25 18V8.75L14 2.75Z" />
      <path d="M9 10h2a2 2 0 1 1 0 4H9v-4Zm0 0v4M14 10h2v4h-2M16 12h-2" fill="none" stroke="#ef4444" strokeWidth="1.4" />
      <path d="M14 2.75V7a1.75 1.75 0 0 0 1.75 1.75H19.25" fill="none" stroke="currentColor" strokeWidth="1.2" />
    </svg>
  );
}
...
export function Grid(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M3 4.75A1.75 1.75 0 0 1 4.75 3h4.5A1.75 1.75 0 0 1 11 4.75v4.5A1.75 1.75 0 0 1 9.25 11h-4.5A1.75 1.75 0 0 1 3 9.25v-4.5ZM13 4.75A1.75 1.75 0 0 1 14.75 3h4.5A1.75 1.75 0 0 1 21 4.75v4.5A1.75 1.75 0 0 1 19.25 11h-4.5A1.75 1.75 0 0 1 13 9.25v-4.5ZM3 14.75A1.75 1.75 0 0 1 4.75 13h4.5A1.75 1.75 0 0 1 11 14.75v4.5A1.75 1.75 0 0 1 9.25 21h-4.5A1.75 1.75 0 0 1 3 19.25v-4.5ZM13 14.75A1.75 1.75 0 0 1 14.75 13h4.5A1.75 1.75 0 0 1 21 14.75v4.5A1.75 1.75 0 0 1 19.25 21h-4.5A1.75 1.75 0 0 1 13 19.25v-4.5Z" />
    </svg>
  );
}
...
export function List(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M4 6.25h16a.75.75 0 0 1 0 1.5H4a.75.75 0 1 1 0-1.5Zm0 5h16a.75.75 0 0 1 0 1.5H4a.75.75 0 1 1 0-1.5Zm0 5h16a.75.75 0 0 1 0 1.5H4a.75.75 0 1 1 0-1.5Z" />
    </svg>
  );
}
...
export function BellIcon(props: PropsType) {
  return (
    <svg width={24} height={24} viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M12 3a5 5 0 0 0-5 5v2.8c0 .5-.2.98-.55 1.33L5.1 13.47c-.95.95-.28 2.53 1.07 2.53H17.83c1.35 0 2.02-1.58 1.07-2.53l-1.35-1.35c-.35-.35-.55-.83-.55-1.33V8a5 5 0 0 0-5-5Z" stroke="currentColor" strokeWidth={1.5} />
