    ...
    <div className={className}>
      ...
      >
        <input
          ...
          className={cn(
            "w-full rounded-lg border-[1.5px] border-stroke bg-transparent outline-none transition focus:border-primary disabled:cursor-default disabled:bg-gray-2 mock-[active=true]:border-primary dark:border-dark-3 dark:bg-dark-1 dark:focus:border-primary dark:disabled:bg-dark dark:mock-[active=true]:border-primary",
            type === "file"
