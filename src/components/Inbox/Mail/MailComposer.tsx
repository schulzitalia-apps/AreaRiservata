  ...
  return (
    <div className="rounded-[24px] border border-stroke/80 bg-white p-5 dark:border-dark-3/80 dark:bg-gray-dark">
      <div className="mb-5 flex flex-wrap items-start justify-between gap-3">
        <div>
          <div className="text-lg font-semibold text-dark dark:text-white">Destinatari e mittente</div>
          <div className="mt-1 text-sm text-dark/60 dark:text-white/60">
            Puoi inserire la mail a mano oppure cercare un&apos;anagrafica per recuperare email e dati utili alla compilazione.
          </div>
        </div>
        <div className="flex flex-wrap gap-2">
          ...
          <button
            ...
            disabled={hardDisabled}
            className={cn(
              "rounded-xl border border-stroke px-3 py-2 text-xs font-semibold text-dark transition hover:bg-gray-1",
      ...
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
        <div>
          ...
          {props.recipientPill ? (
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <div className="inline-flex items-center gap-2 rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5 text-xs font-medium text-dark dark:text-white">
          ...
          <div className="mt-6 rounded-2xl border border-stroke/80 bg-gray-1/20 p-4 dark:border-dark-3/80 dark:bg-black/10">
            <div className="mb-3 flex items-center justify-between gap-3">
              <div>
                ...
                <div className="mt-1 text-xs text-dark/60 dark:text-white/60">
                  {props.ccRecipients.length
                    ? "Questi destinatari ricevono la mail in conoscenza e non cambiano la bozza."
                    : "La copia e facoltativa e non influisce sul testo della mail."}
                </div>
              </div>
            </div>
            ...
            {props.ccRecipients.length ? (
              ...
              <div className="rounded-2xl border border-dashed border-stroke/80 bg-white/70 px-4 py-4 dark:border-dark-3/80 dark:bg-black/10">
                <div className="text-sm font-medium text-dark dark:text-white">
                  Nessuna email in copia selezionata
                </div>
                <div className="mt-1 text-xs text-dark/60 dark:text-white/60">
                  Aggiungila solo se serve, poco prima dell&apos;invio.
                </div>
              </div>
            )}
          </div>
        ...
        <div>
          <div className="rounded-2xl border border-stroke/80 bg-gray-1/20 p-4 dark:border-dark-3/80 dark:bg-black/10">
            ...
            <div className="mt-3 rounded-xl border border-dashed border-stroke/80 px-3 py-3 text-xs leading-5 text-dark/60 dark:border-dark-3/80 dark:text-white/60">
              Il mittente puo essere scelto in qualsiasi momento, ma va verificato prima dell&apos;invio finale.
            </div>
          </div>
        </div>
      </div>
