// src/app/api/aule/[type]/[id]/attachments/[attachmentId]/route.ts
import { NextRequest, NextResponse } from "next/server";
import { requireAuth } from "@/server-utils/lib/auth-guards";
import { removeAttachmentFromAula } from "@/server-utils/service/auleQuery";
...
// DELETE /api/aule/:type/:id/attachments/:attachmentId?removeDocument=1
export async function DELETE(
  ...
  const removed = await removeAttachmentFromAula({
    type,
    id,
    attachmentId,
    updatedById,
