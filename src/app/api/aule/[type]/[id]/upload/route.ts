...
export async function POST(
  ...
  // valida attachmentType (se presente lista)
  if (
    Array.isArray(def.documentTypes) &&
    !def.documentTypes.includes(attachmentType)
  ) {
  ...
  // evita category="auto" se mai arrivasse
