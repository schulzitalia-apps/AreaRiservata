...
// INFO: Modifica me per avere variazioni sul tema scelto, io determino le regole di tailwind per tutto il resto della piattaforma!

const config: Config = {
  content: ["./src/**/*.{vector-maps,jsx,tsx,ts}"],
  darkMode: ["class"],
  theme: {
    extend: {
      fontFamily: {
